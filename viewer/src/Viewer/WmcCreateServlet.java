...
//      String strWebapp = tempFile.getParent()+ "/../../../../webapps/viewer";
...
//      boolean success = tempFile.renameTo(new File(dir, tempFile.getName()));
//      if (success) {
//          // File was not successfully moved
//    	  out.write("{success: true, url: '" + getBaseUrl(request) + "/../" + tempFile.getName() + "'}");
//      }
