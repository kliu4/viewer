...
public class Kmztokml extends HttpServlet {
	...
	private String kmzToKml(String kmzUrl) {
		...
		try {
			...
			ZipInputStream inStream = zin; // new ZipInputStream(new
	...
	public static void main(String[] args) {
		...
		String kmlDoc = toKml
				.kmzToKml("https://sites.google.com/site/geined13/tours/080505-__USGS_Real-time_Earthquakes_%5B73112%5D.kmz?attredirects=0&d=1");
